...
//        System.out.println("user connecté email ="+ SessionManager.getEmail());
        ...
        RadioButton partage = RadioButton.createToggle("Liste Réponses", barGroup);
...
//            etatTxt.setText("Traitée");
        ...
        FontImage mFontImagee = FontImage.createMaterial(FontImage.MATERIAL_BOOKMARK_ADD, RepondreStyle);
        lrepondre.setIcon(mFontImagee);
        lrepondre.setTextPosition(LEFT);
        
        
        lrepondre.addPointerPressedListener(l -> {
            System.out.println("hello Repondre :: "+rec);
