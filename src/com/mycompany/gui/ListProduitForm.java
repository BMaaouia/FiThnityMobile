...
//        System.out.println("user connecté email ="+ SessionManager.getEmail());
    ...
    private void addButton(Image img, Produit rec, Resources res) {
        ...
        Label nomtTxt = new Label("Nom De Produit : "+rec.getNomProduit(),"NewsTopLine2");
                Label sujetTxt = new Label("Poids : "+rec.getPoids(),"NewsTopLine2");
                        Label etatText = new Label("Description : "+rec.getDescription(),"NewsTopLine2");
...
lSupprimer.addPointerPressedListener(l -> {
    ...
    if(ServiceProduit.getInstance().deleteProduit(rec.getId_produit())) {
