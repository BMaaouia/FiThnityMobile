...
public class ServiceProduit {
    ...
    public void ajoutProduit(Produit produit) {
        ...
        String url =Statics.BASE_URL+"/addProduit?nomProduit="+produit.getNomProduit()+"&poids="+produit.getPoids()+"&description="+produit.getDescription(); 
...
String url = Statics.BASE_URL +"/supp_produit/" +id_produit;
    req.setUrl(url);
    ...
    public boolean modifierProduit(Produit produit) {
        String url = Statics.BASE_URL + "/modifProduit/" + produit.getId_produit()
