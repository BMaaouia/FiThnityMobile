...
import com.mycompany.gui.AjoutReponseForm;
 ...
 * @author MSI
 */
public class ListReponseForm extends BackForm{
    ...
    private void addButton(Image img,Reponse rep , Resources res) {
      Reclamation rec=new Reclamation();
        ...
        //kif nzidouh  ly3endo date mathbih fi codenamone y3adih string w y5alih f symfony dateTime w ytab3ni cha3mlt taw yjih
           // Label idtxt = new Label("idRep : "+rep.getIdReponse(),"NewsTopLine2" );
                Label datetxt = new Label("Date : "+rep.getDatereponse(),"NewsTopLine2" );
                        Label emailText = new Label("Email : "+rep.getEmailuser(),"NewsTopLine2"); 
        Label messagetxt = new Label("Reponse : "+rep.getMessager(),"NewsTopLine2");
        ...
        FontImage mFontImagee = FontImage.createMaterial(FontImage.MATERIAL_MODE_EDIT, RepondreStyle);
        lrepondre.setIcon(mFontImagee);
