...
public class ListCommentForm extends BaseForm{
    ...
    Form current;
    public ListCommentForm(Resources res, Blog b ) {
...
//        System.out.println("user connecté email ="+ SessionManager.getEmail());
        ...
        ArrayList<Comment>list = ServiceComment.getInstance().affichageComment(b.getId_blog());
        System.out.println(b.getId_blog());
        for(Comment rec  : list ) {
    ...
    private void addButton(Image img,Comment rec ,Blog b, Resources res) {
        ...
        Label nomtTxt = new Label("nom_prenom : "+rec. getNom_prenom(),"NewsTopLine2");
                Label prenomTxt = new Label("Text_comment : "+rec. getText_comment(),"NewsTopLine2");
...
//            etatTxt.setText("Traitée");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
                ...
                if(ServiceComment.getInstance().deleteComment(rec.getId_comment())) {
...
//        
        ...
        lcomment.addPointerPressedListener(l -> {
            //Ziid l form mtaa modifier;
            new ModifierCommentForm(res,rec,b).show();
        });
...
//           BoxLayout.encloseX(nomtTxt),
                    ...
                    //   BoxLayout.encloseX(Typetxt,lModifier);
                                             BoxLayout.encloseX(lcomment,lSupprimer)));
