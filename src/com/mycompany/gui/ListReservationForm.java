...
public class ListReservationForm extends BaseForm{
        private Reservation reclamation;
...
//        System.out.println("user connecté email ="+ SessionManager.getEmail());
        ...
        RadioButton liste = RadioButton.createToggle("Reservation ", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Mes Reservations", barGroup);
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
          ...
          AjoutReservationForm a = new AjoutReservationForm(res);
            a.show();
            refreshTheme();
        });
    ...
    private void addButton(Image img, Reservation rec, Resources res) {
...
//       Label Txt = new Label("Reference : "+rec.getReference()),"NewsTopLine2");
       Label refeTxt = new Label("Reference : "+rec.getReference(),"NewsTopLine2");
       Label prixTxt = new Label("Prix : "+rec.getPrix(),"NewsTopLine2");

       Label poidsTxt = new Label("Poids : "+rec.getPoids(),"NewsTopLine2");
//
//    Label dateText = new Label("Date Resr : "+rec.getDateReser(),"NewsTopLine2");
    Label vdText = new Label("ville depart : "+rec.getVilleDepart(),"NewsTopLine2");
    Label vaText = new Label("ville Arrive : "+rec.getVilleArrive(),"NewsTopLine2");
   Label idPText = new Label("Id Produit : "+rec.getId_produit(),"NewsTopLine2");
//
//  Label sujetTxt = new Label("Poids : "+rec.getPoids(),"NewsTopLine2");
...
lSupprimer.addPointerPressedListener(l -> {
    ...
    if(ServiceReservation.getInstance().deleteReservation(rec.getId_r())) {
        Dialog.show("Confirmation", "Produit supprimé avec succès", "OK", null);
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(refeTxt),
                BoxLayout.encloseX(prixTxt),
         BoxLayout.encloseX(poidsTxt),
//         BoxLayout.encloseX(dateText),
                BoxLayout.encloseX(vdText),
         BoxLayout.encloseX(vaText),
         BoxLayout.encloseX(idPText),
