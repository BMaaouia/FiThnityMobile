...
public class ServiceVehicule {
  ...
  public void ajoutVehicule(Vehicule vehicule) {
    ...
    String url = Statics.BASE_URL + "/modifvehiculemobile/" + vehicule.getidV() + "?modele=" + vehicule.getModele() + "&immatriculation=" + vehicule.getImmatriculation() + "&categorie=" + vehicule.getCategorie() + "&etat=" + vehicule.getEtat()  + "&imageVehicule=" + vehicule.getImageVehicule() ;
        req.setUrl(url);
