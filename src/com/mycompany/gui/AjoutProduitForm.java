...
public class AjoutProduitForm extends BaseForm {
    ...
    public AjoutProduitForm(Resources res ) {
        ...
        RadioButton partage = RadioButton.createToggle("Mes Produit", barGroup);
        ...
        TextField nomdeproduit = new TextField("", "entrer Nom De Produit!!");
        nomdeproduit.setUIID("nom_Produit");
        addStringValue("nom_Produit",nomdeproduit);
        ...
        btnAjouter.addActionListener((e) -> {
             String errorMessage = validateFields(nomdeproduit, poids, description);
            ...
            try {
                ...
                if(nomdeproduit.getText().equals("") || poids.getText().equals("")|| description.getText().equals("")) {
                    ...
                    Produit r = new Produit(String.valueOf(nomdeproduit.getText()).toString(),
                      poidsEntier,
...
Dialog.show("Confirmation", "Produit Ajoutée avec succès", "OK", null);
...
private void addStringValue2( ComboBox comboBox, Container container) {
   ...
   public String validateFields(TextField nomdeproduit, TextField poids, TextField description) {
    StringBuilder errorMessage = new StringBuilder();

    if (nomdeproduit.getText().isEmpty()) {
