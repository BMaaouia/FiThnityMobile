...
public class AjoutReponseForm extends BaseForm {
    ...
    public AjoutReponseForm(Resources res, Reclamation reclamation ) {
        ...
        //
          ...
          TextField reponse = new TextField("", "entrer reponse!!");
        reponse.setUIID("reponse");
        addStringValue("messager",reponse);
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if( reponse.getText().equals("")) {
                   ...
                   Reponse rep = new Reponse( String.valueOf(reponse.getText()).toString(),format.format(new Date()));
...
refreshTheme(); //Actualisation
   ...
   public String validateFields( TextField reponse) {
    ...
    if (reponse.getText().isEmpty()) {
        errorMessage.append("Le champ reponse est obligatoire.\n");
    }
