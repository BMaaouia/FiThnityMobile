...
String url = Statics.BASE_URL + "/addEmployee?firstname_employee=" + employee.getFirstname_employee() + "&lastname_employee=" + employee.getLastname_employee() + "&email_employee=" + employee.getEmail_employee() + "&address_employee=" + employee.getAddress_employee() + "&id_v=" + employee.getId_vehicule();
    ...
    String url = Statics.BASE_URL + "/employee";
        req.setUrl(url);
    ...
    String url = Statics.BASE_URL + "/modifEmployee/" + employee.getId_employee() + "?firstname_employee=" + employee.getFirstname_employee() + "&lastname_employee=" + employee.getLastname_employee() + "&email_employee=" + employee.getEmail_employee() + "&address_employee=" + employee.getAddress_employee() ;
        req.setUrl(url);
