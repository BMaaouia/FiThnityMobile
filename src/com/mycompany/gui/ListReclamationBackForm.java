...
// * @author MSI
// */
//public class ListReclamationBackForm extends BaseForm{
//      private Reclamation reclamation;
//
//    Form current;
//    public ListReclamationBackForm(Resources res ) {
...
//        RadioButton liste = RadioButton.createToggle("Repondre ", barGroup);
//        liste.setUIID("SelectBar");
//        RadioButton partage = RadioButton.createToggle("Mes Reponses", barGroup);
...
//        ArrayList<Reclamation>list = ServiceEmployee.getInstance().affichageReclamations();
//        
...
//                        Label etatText = new Label("Etat : "+rec.getEtat(),"NewsTopLine2");
//       
//
//        createLineSeparator();
//        
...
//                if(ServiceEmployee.getInstance().deleteReclamation(rec.getId())) {
...
//            new ModifierReclamationBackForm(res,rec).show();
//        });
//        
//         //Repondre icon 
//        Label lRepondre = new Label(" ");
//        lRepondre.setUIID("NewsTopLine");
//        Style repondreStyle = new Style(lRepondre.getUnselectedStyle());
//        repondreStyle.setFgColor(0xf7ad02);
//        
//        FontImage mFontImager = FontImage.createMaterial(FontImage.MATERIAL_BOOKMARK_ADD, repondreStyle);
//        lRepondre.setIcon(mFontImager);
//        lRepondre.setTextPosition(LEFT);
//        
//        
//        lRepondre.addPointerPressedListener(l -> {
//            System.out.println("hello update");
//            new AjoutReponseForm(res,rec).show();
//        });
//        
//        
...
//         BoxLayout.encloseX(etatText),
//       
//                    //   BoxLayout.encloseX(Typetxt,lModifier);
//                                             BoxLayout.encloseX(lRepondre,lModifier,lSupprimer)));
//
//     add(cnt);
//           
//   
