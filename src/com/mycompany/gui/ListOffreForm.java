 ...
 * @author Lenovo
 */
public class ListOffreForm extends BackForm{
        private Offre offre;
...
//        System.out.println("user connecté email ="+ SessionManager.getEmail());
    ...
    private void addButton(Image img,Offre o , Resources res) {
        ...
        Label idTxt =new Label("id : " + o.getId(), "NewsTopLine2");
        Label metierTxt = new Label("Métier : " + o.getMetier(), "NewsTopLine2");
        Label villeTxt = new Label("Ville : " + o.getVille(), "NewsTopLine2");
        Label secteurTxt = new Label("Secteur : " + o.getSecteur(), "NewsTopLine2");
        Label nombreTxt = new Label("Nombre de postes : " + o.getNombredeposte(), "NewsTopLine2");
        Label salaireTxt = new Label("Salaire : " + o.getsalaire() + " DT", "NewsTopLine2");
        Label dateTxt = new Label("Date : " + o.getDateoffre(), "NewsTopLine2"); // Ajout de la date
...
//            etatTxt.setText("Traitée");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce offre ?","Annuler","Oui")) {
                dig.dispose();
            }
            else {
                dig.dispose();
                 }
                //n3ayto l suuprimer men service Offre
                if(ServiceOffre.getInstance().deleteOffre(o.getId())) {
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierOffreForm(res,o).show();
        });
        
        
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                
                BoxLayout.encloseX(metierTxt),
                BoxLayout.encloseX(villeTxt),
         BoxLayout.encloseX(secteurTxt),
          BoxLayout.encloseX(nombreTxt),
                BoxLayout.encloseX(salaireTxt),
