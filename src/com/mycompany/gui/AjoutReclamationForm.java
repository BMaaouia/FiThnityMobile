...
public class AjoutReclamationForm extends BaseForm {
    ...
    public AjoutReclamationForm(Resources res ) {
        ...
        nom.setUIID("nom_client");
        addStringValue("nom_client",nom);
        
        TextField sujet = new TextField("", "entrer sujet!!");
        sujet.setUIID("sujet");
        addStringValue("sujet",sujet);
        
          TextField etat = new TextField("", "entrer etat de rec!!");
        etat.setUIID("etat");
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(nom.getText().equals("") || sujet.getText().equals("")|| etat.getText().equals("")) {
