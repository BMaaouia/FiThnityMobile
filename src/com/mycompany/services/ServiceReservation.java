...
String url = Statics.BASE_URL + "/modifReservationmobile/" + reservation.getId_r()+"?reference"+reservation.getReference()+"&prix=" + reservation.getPrix() +"&poids=" + reservation.getPoids() +"&id_produit=" + reservation.getId_produit() +"&ville_depart=" + reservation.getVilleDepart() +"&ville_arrive=" + reservation.getVilleArrive();
    ...
    public ArrayList<Reservation>affichageReservation() {
        ...
        String url = Statics.BASE_URL+"/rmobile";
        req.setUrl(url);
