 ...
 * @author Lenovo
 */
public class AjoutCommentForm extends BaseForm {
    
    
    Form current;
        private Resources theme;

    public AjoutCommentForm(Resources res , Blog b) {
...
//        addStringValue("Description",description);
        ...
        TextField text = new TextField("", "entrer text!!");
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(nom_prenom.getText().equals("") || text.getText().equals("")) {
...
//                    ServiceReclamation.getInstance().ajoutReclamation(r);
                      ...
                      Comment c = new Comment( text.getText().toString(),nom_prenom.getText().toString());
                      ServiceComment.getInstance().ajoutComment(c,b);
