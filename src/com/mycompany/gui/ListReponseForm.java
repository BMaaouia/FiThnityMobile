...
public class ListReponseForm extends BaseForm{
    ...
    public ListReponseForm(Resources res ) {
        ...
        RadioButton mesListes = RadioButton.createToggle("Les Reclamtions", barGroup);
   ...
   //   Reponse rec=new Reponse();
        ...
        //kif nzidouh  ly3endo date mathbih fi codenamone y3adih string w y5alih f symfony dateTime w ytab3ni cha3mlt taw yjih
           // Label idtxt = new Label("idRep : "+rep.getIdReponse(),"NewsTopLine2" );
                                   Label reponseText = new Label("Reponse : "+rep.getReponse(),"NewsTopLine2"); 

                Label datetxt = new Label("Date : "+rep.getDate(),"NewsTopLine2" );
...
//            etatTxt.setText("Traitée");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cet reponse ?","Annuler","Oui")) {
               // dig.dispose();
            }
           
                //n3ayto l suuprimer men service Reclamation
              if(ServiceReponse.getInstance().deleteReponse(rep.getId())) {
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
         ...
         BoxLayout.encloseX(reponseText),
